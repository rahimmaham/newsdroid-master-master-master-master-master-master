...
public class AdminNewsFeed extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ImageAdapter(AdminNewsFeed.this, mUpload);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(AdminNewsFeed.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.admin_news_feed, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_news) {
            Intent i =new Intent(AdminNewsFeed.this,AdminNewsFeed.class);
            startActivity(i);
        }
        else if (id == R.id.nav_prof){
            Intent i =new Intent(AdminNewsFeed.this,AdminProfile.class);
            startActivity(i);
        }
